...
#ifndef EJERCICIO_TRES__SRV__DETAIL__MIDPOINT__FUNCTIONS_H_
#define EJERCICIO_TRES__SRV__DETAIL__MIDPOINT__FUNCTIONS_H_
...
#include "ejercicio_tres/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_ejercicio_tres
bool
 ...
 * calls
 * ejercicio_tres__srv__Midpoint_Request__init().
...
/**
 * It calls
 * ejercicio_tres__srv__Midpoint_Request__fini()
 ...
 * ejercicio_tres__srv__Midpoint_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ejercicio_tres__srv__Midpoint_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ejercicio_tres__srv__Midpoint_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ejercicio_tres
...
/**
 * It calls
 * ejercicio_tres__srv__Midpoint_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ejercicio_tres
...
/**
 * It allocates the memory for the array and calls
 * ejercicio_tres__srv__Midpoint_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ejercicio_tres
...
/**
 * It calls
 * ejercicio_tres__srv__Midpoint_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EJERCICIO_TRES__SRV__DETAIL__MIDPOINT__FUNCTIONS_H_
