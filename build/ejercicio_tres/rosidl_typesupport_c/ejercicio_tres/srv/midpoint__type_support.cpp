...
static const _Midpoint_Request_type_support_symbol_names_t _Midpoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ejercicio_tres, srv, Midpoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ejercicio_tres, srv, Midpoint_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ejercicio_tres, srv, Midpoint_Request)() {
  return &::ejercicio_tres::srv::rosidl_typesupport_c::Midpoint_Request_message_type_support_handle;
}
...
static const _Midpoint_Response_type_support_symbol_names_t _Midpoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ejercicio_tres, srv, Midpoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ejercicio_tres, srv, Midpoint_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ejercicio_tres, srv, Midpoint_Response)() {
  return &::ejercicio_tres::srv::rosidl_typesupport_c::Midpoint_Response_message_type_support_handle;
}
...
static const _Midpoint_type_support_symbol_names_t _Midpoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ejercicio_tres, srv, Midpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ejercicio_tres, srv, Midpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ejercicio_tres, srv, Midpoint)() {
  return &::ejercicio_tres::srv::rosidl_typesupport_c::Midpoint_service_type_support_handle;
}
