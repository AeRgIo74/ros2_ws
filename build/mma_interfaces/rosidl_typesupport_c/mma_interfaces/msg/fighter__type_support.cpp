...
static const _Fighter_type_support_symbol_names_t _Fighter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mma_interfaces, msg, Fighter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mma_interfaces, msg, Fighter)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mma_interfaces, msg, Fighter)() {
  return &::mma_interfaces::msg::rosidl_typesupport_c::Fighter_message_type_support_handle;
}
