...
bool mma_interfaces__msg__fighter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mma_interfaces.msg._fighter.Fighter", full_classname_dest, 35) == 0);
  }
  mma_interfaces__msg__Fighter * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of Fighter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mma_interfaces.msg._fighter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Fighter");
