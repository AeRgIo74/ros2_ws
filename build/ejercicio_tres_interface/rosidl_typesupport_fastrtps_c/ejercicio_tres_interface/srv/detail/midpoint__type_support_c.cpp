...
#include "ejercicio_tres_interface/srv/detail/midpoint__rosidl_typesupport_fastrtps_c.h"
...
#include "ejercicio_tres_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Midpoint_Request__ros_msg_type = ejercicio_tres_interface__srv__Midpoint_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ejercicio_tres_interface
size_t get_serialized_size_ejercicio_tres_interface__srv__Midpoint_Request(
  const void * untyped_ros_message,
...
static uint32_t _Midpoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ejercicio_tres_interface__srv__Midpoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ejercicio_tres_interface
size_t max_serialized_size_ejercicio_tres_interface__srv__Midpoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ejercicio_tres_interface__srv__Midpoint_Request;
    is_plain =
      (
...
static size_t _Midpoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ejercicio_tres_interface__srv__Midpoint_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ejercicio_tres_interface, srv, Midpoint_Request)() {
...
using _Midpoint_Response__ros_msg_type = ejercicio_tres_interface__srv__Midpoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ejercicio_tres_interface
size_t get_serialized_size_ejercicio_tres_interface__srv__Midpoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Midpoint_Response__ros_msg_type * ros_message = static_cast<const _Midpoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ejercicio_tres_interface__srv__Midpoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ejercicio_tres_interface
size_t max_serialized_size_ejercicio_tres_interface__srv__Midpoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ejercicio_tres_interface__srv__Midpoint_Response;
    is_plain =
      (
...
static size_t _Midpoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ejercicio_tres_interface__srv__Midpoint_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ejercicio_tres_interface, srv, Midpoint_Response)() {
...
// already included above
// #include "ejercicio_tres_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ejercicio_tres_interface/srv/midpoint.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ejercicio_tres_interface, srv, Midpoint)() {
