...
#include "ejercicio_tres_interface/srv/detail/midpoint__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ejercicio_tres_interface::srv::Midpoint_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ejercicio_tres_interface::srv::Midpoint_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ejercicio_tres_interface::srv::Midpoint_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ejercicio_tres_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<ejercicio_tres_interface::srv::Midpoint_Request>()
{
  return &ejercicio_tres_interface::srv::typesupport_fastrtps_cpp::_Midpoint_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ejercicio_tres_interface::srv::Midpoint_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ejercicio_tres_interface::srv::Midpoint_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ejercicio_tres_interface::srv::Midpoint_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ejercicio_tres_interface::srv::typesupport_fastrtps_cpp::_Midpoint_Response__handle;
}
...
{
  return &ejercicio_tres_interface::srv::typesupport_fastrtps_cpp::_Midpoint__handle;
}
