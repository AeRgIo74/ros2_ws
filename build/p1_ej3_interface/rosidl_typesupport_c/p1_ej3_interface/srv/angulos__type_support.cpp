...
static const _Angulos_Request_type_support_symbol_names_t _Angulos_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, p1_ej3_interface, srv, Angulos_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, p1_ej3_interface, srv, Angulos_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, p1_ej3_interface, srv, Angulos_Request)() {
  return &::p1_ej3_interface::srv::rosidl_typesupport_c::Angulos_Request_message_type_support_handle;
}
...
static const _Angulos_Response_type_support_symbol_names_t _Angulos_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, p1_ej3_interface, srv, Angulos_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, p1_ej3_interface, srv, Angulos_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, p1_ej3_interface, srv, Angulos_Response)() {
  return &::p1_ej3_interface::srv::rosidl_typesupport_c::Angulos_Response_message_type_support_handle;
}
...
static const _Angulos_type_support_symbol_names_t _Angulos_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, p1_ej3_interface, srv, Angulos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, p1_ej3_interface, srv, Angulos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, p1_ej3_interface, srv, Angulos)() {
  return &::p1_ej3_interface::srv::rosidl_typesupport_c::Angulos_service_type_support_handle;
}
