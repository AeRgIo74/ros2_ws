...
#include "p1_ej2_interface/msg/detail/sensor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const p1_ej2_interface::msg::Sensor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  p1_ej2_interface::msg::Sensor & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = p1_ej2_interface::msg::Sensor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const p1_ej2_interface::msg::Sensor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<p1_ej2_interface::msg::Sensor *>(
    untyped_ros_message);
...
{
  return &p1_ej2_interface::msg::typesupport_fastrtps_cpp::_Sensor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, p1_ej2_interface, msg, Sensor)() {
  return &p1_ej2_interface::msg::typesupport_fastrtps_cpp::_Sensor__handle;
}
