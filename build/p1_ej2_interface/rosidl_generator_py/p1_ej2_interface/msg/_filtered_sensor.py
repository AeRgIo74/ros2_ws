...
class Metaclass_FilteredSensor(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('p1_ej2_interface')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'p1_ej2_interface.msg.FilteredSensor')
            logger.debug(
...
class FilteredSensor(metaclass=Metaclass_FilteredSensor):
    ...
    def __init__(self, **kwargs):
        ...
        self.average_value = kwargs.get('average_value', float())
    ...
    def average_value(self, value):
        if __debug__:
            assert \
                ...
                "The 'average_value' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'average_value' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
