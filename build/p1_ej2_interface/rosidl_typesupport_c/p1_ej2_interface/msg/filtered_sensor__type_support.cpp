...
static const _FilteredSensor_type_support_symbol_names_t _FilteredSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, p1_ej2_interface, msg, FilteredSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, p1_ej2_interface, msg, FilteredSensor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, p1_ej2_interface, msg, FilteredSensor)() {
  return &::p1_ej2_interface::msg::rosidl_typesupport_c::FilteredSensor_message_type_support_handle;
}
