...
{
  new (message_memory) p1_ej2_interface::msg::Sensor(_init);
}

void Sensor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<p1_ej2_interface::msg::Sensor *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sensor_message_member_array[1] = {
  {
    ...
    offsetof(p1_ej2_interface::msg::Sensor, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sensor_message_members = {
  ...
  "Sensor",  // message name
  1,  // number of fields
  sizeof(p1_ej2_interface::msg::Sensor),
...
{
  return &::p1_ej2_interface::msg::rosidl_typesupport_introspection_cpp::Sensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, p1_ej2_interface, msg, Sensor)() {
  return &::p1_ej2_interface::msg::rosidl_typesupport_introspection_cpp::Sensor_message_type_support_handle;
}
