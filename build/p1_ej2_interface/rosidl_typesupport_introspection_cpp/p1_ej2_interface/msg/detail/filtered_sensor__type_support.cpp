...
{
  new (message_memory) p1_ej2_interface::msg::FilteredSensor(_init);
}

void FilteredSensor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<p1_ej2_interface::msg::FilteredSensor *>(message_memory);
  typed_message->~FilteredSensor();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember FilteredSensor_message_member_array[1] = {
  {
    "average_value",  // name
    ...
    offsetof(p1_ej2_interface::msg::FilteredSensor, average_value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FilteredSensor_message_members = {
  "p1_ej2_interface::msg",  // message namespace
  "FilteredSensor",  // message name
  1,  // number of fields
  sizeof(p1_ej2_interface::msg::FilteredSensor),
...
{
  return &::p1_ej2_interface::msg::rosidl_typesupport_introspection_cpp::FilteredSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, p1_ej2_interface, msg, FilteredSensor)() {
  return &::p1_ej2_interface::msg::rosidl_typesupport_introspection_cpp::FilteredSensor_message_type_support_handle;
}
