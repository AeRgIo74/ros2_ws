...
bool p1_ej2_interface__msg__sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("p1_ej2_interface.msg._sensor.Sensor", full_classname_dest, 35) == 0);
  }
  p1_ej2_interface__msg__Sensor * ros_message = _ros_message;
  {  // data
...
PyObject * p1_ej2_interface__msg__sensor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("p1_ej2_interface.msg._sensor");
