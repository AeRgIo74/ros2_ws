...
#include "p1_ej2_interface/msg/detail/filtered_sensor__rosidl_typesupport_fastrtps_c.h"
...
#include "p1_ej2_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _FilteredSensor__ros_msg_type = p1_ej2_interface__msg__FilteredSensor;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_p1_ej2_interface
size_t get_serialized_size_p1_ej2_interface__msg__FilteredSensor(
  const void * untyped_ros_message,
...
static uint32_t _FilteredSensor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_p1_ej2_interface__msg__FilteredSensor(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_p1_ej2_interface
size_t max_serialized_size_p1_ej2_interface__msg__FilteredSensor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = p1_ej2_interface__msg__FilteredSensor;
    is_plain =
      (
...
static size_t _FilteredSensor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_p1_ej2_interface__msg__FilteredSensor(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, p1_ej2_interface, msg, FilteredSensor)() {
